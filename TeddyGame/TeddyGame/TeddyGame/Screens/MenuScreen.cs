...
namespace Prototype2
{
    ...
    abstract class MenuScreen : GameScreen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (GameStateManagementGame.music == 1 && !GameStateManagementGame.gameSongsCue.IsPlaying)
            {                
                 GameStateManagementGame.gameSongsCue = GameStateManagementGame.soundBank.GetCue("menumusic");
